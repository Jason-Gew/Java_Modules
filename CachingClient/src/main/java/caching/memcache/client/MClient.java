...
public interface MClient {
    ...
    static MClient getInstance() {
        System.err.println("This Static Method Should Not Be Invoked Only in the Interface.");
        return null;
    }
    ...
    <T> Optional<T> get(final String key, final Integer timeout) throws TimeoutException, MemcachedException;
    ...
    boolean set(final String key, final Integer timeout, Object value) throws TimeoutException, MemcachedException;

    boolean add(final String key, Object value) throws TimeoutException, MemcachedException;

    boolean add(final String key, final Integer timeout, Object value) throws TimeoutException, MemcachedException;

    boolean append(final String key, final Object value) throws TimeoutException, MemcachedException ;

    boolean touch(final String key, final Integer timeout) throws TimeoutException, MemcachedException;
